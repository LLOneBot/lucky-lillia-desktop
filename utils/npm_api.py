...
def get_package_info(package_name: str, timeout: int = UPDATE_CHECK_TIMEOUT, 
    ...
    for registry in registry_mirrors:
        try:
            ...
            result = _get_package_from_registry(package_name, registry, timeout)
...
def _get_package_from_registry(package_name: str, registry: str, timeout: int) -> Optional[Dict[str, Any]]:
    """从npm registry获取包信息"""
    # 构建API URL - 获取最新版本
